...
- The `platform-data-postgres-operator` ArgoCD Application confirmed `Synced/Healthy`, controller Deployment `1/1` live.
- The `data` namespace confirms `PostgresCluster/postgres` single-shard `Ready=True`.
