...
| [ADR-0024](0024-lefthook-pre-push-incremental-lint-envtest.md) | lefthook pre-push incremental lint (--new-from-rev) + envtest binary 자동 보장 (RFC-0002 후 push 차단 회피, family sister-port) | Accepted | 2026-05-21 |
