...
| [INC-0002](INC-0002-stale-primary-role-label-rw-outage-20260711.md) | 죽은 노드의 구 primary Pod가 role=primary 라벨을 계속 보유해 rw 라우팅 8h+ 장애 | SEV-1 | 2026-07-11 | Open (fix 코드 push 완료, PR/클러스터 롤아웃 대기) |
