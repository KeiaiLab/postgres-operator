...
| 항목 | 상태 | Evidence |
|---|---|---|
| 프로젝트 / chart 이름 | `postgres-operator` | GitHub repo, Helm chart, argos GitOps path 모두 정합 |
...
- [x] ArgoCD `Synced/Healthy` — argos production 에서 검증 (`platform-data-postgres-operator`).
